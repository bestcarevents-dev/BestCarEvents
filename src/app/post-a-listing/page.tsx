        ...
        <div className="mb-12 bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-yellow-200 rounded-2xl p-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-6 font-medium">
              Car listings are normally paid, but we're offering them <span className="font-bold text-yellow-600">completely FREE for the first two months</span> after our launch!
            </p>
