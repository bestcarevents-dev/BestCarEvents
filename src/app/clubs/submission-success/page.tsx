      ...
      <div className="container mx-auto px-4 py-12">
        <Card className="max-w-2xl mx-auto bg-white border border-gray-200 shadow-sm">
          <CardHeader className="text-center bg-gray-50 border-b border-gray-200">
            ...
            <CardTitle className="text-3xl font-bold font-headline text-gray-900">Car Club Submitted!</CardTitle>
            <CardDescription className="text-gray-600 text-lg">
              Thank you for submitting your car club.
            </CardDescription>
          </CardHeader>
            ...
            <div className="space-y-6">
              <div className="text-center">
                <p className="text-gray-700 mb-4">
                  Your club has been successfully submitted and is now under review by our team.
                </p>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="text-blue-800 text-sm space-y-1">
                  ...
                  <li>• We'll verify your contact information and club details</li>
                  <li>• Once approved, your club will appear in our listings</li>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <ul className="text-yellow-800 text-sm space-y-1">
                  <li>• Prepare high-quality images and your club's highlights</li>
                  <li>• Gather social links and event details</li>
                  <li>• Share your upcoming listing with your members</li>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button asChild className="flex-1 bg-yellow-600 hover:bg-yellow-700 text-white">
                  <Link href="/clubs" className="flex items-center justify-center">
                    Browse Car Clubs
              ...
              <div className="text-center pt-4 border-t border-gray-200">
                ...
                <Button asChild variant="link" className="text-yellow-600 hover:text-yellow-700 p-0">
                  <a href="mailto:support@bestcarsales.com?subject=Clubs Submission Question" className="flex items-center justify-center">
