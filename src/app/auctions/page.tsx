        ...
        <>
          ...
          {featuredAuctions.length > 0 ? (
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-headline font-bold text-foreground">Featured Auctions</h2>
          ...
          <div className="mb-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-headline font-bold text-foreground">Live Auctions</h2>
