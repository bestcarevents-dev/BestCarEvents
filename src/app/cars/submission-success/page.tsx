      ...
      <div className="container mx-auto px-4 py-12">
        <Card className="max-w-2xl mx-auto bg-white border border-gray-200 shadow-sm">
          <CardHeader className="text-center bg-gray-50 border-b border-gray-200">
            ...
            <CardTitle className="text-3xl font-bold font-headline text-gray-900">Car Listing Submitted!</CardTitle>
            <CardDescription className="text-gray-600 text-lg">
              Thank you for submitting your car for sale.
            </CardDescription>
          </CardHeader>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="text-blue-800 text-sm space-y-1">
                  ...
                  <li>• Once approved, your car will appear in our listings</li>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <ul className="text-yellow-800 text-sm space-y-1">
                  <li>• Prepare additional high-quality images of your car</li>
                  <li>• Gather service history and documentation</li>
                  <li>• Share your upcoming listing with potential buyers</li>
              ...
              <div className="text-center pt-4 border-t border-gray-200">
                ...
                <Button asChild variant="link" className="text-yellow-600 hover:text-yellow-700 p-0">
                  <a href="mailto:support@bestcarsales.com?subject=Cars Submission Question" className="flex items-center justify-center">
