        ...
        listingTables.map((table) => (
          <Card key={table.label} className="mb-8">
            ...
            <CardContent>
              ...
              {/* Add quota cards for Events Listing section */}
              {table.label === "Events Listing" && userDoc && (
                <div className="mb-6">
                  <h3 className="text-lg font-semibold mb-4">Your Current Event Listing Quota</h3>
              ...
              {/* Add quota cards for Hotel Listing section */}
              {table.label === "Hotel Listing" && userDoc && (
                <div className="mb-6">
                  <h3 className="text-lg font-semibold mb-4">Your Current Hotel Listing Quota</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center justify-between p-3 bg-muted rounded">
                      <div className="flex items-center gap-2">
                        <Info className="w-4 h-4 text-primary" />
              ...
              {/* Add quota cards for Club Listing section */}
