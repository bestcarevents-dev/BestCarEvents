            ...
            <div className="space-y-6">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <ul className="text-yellow-800 text-sm space-y-1">
                  <li>• Prepare high-quality images and a detailed schedule</li>
                  <li>• Gather any sponsors or partner information</li>
                  <li>• Consider upgrading to a featured listing for better visibility</li>
                  <li>• Explore our community forum to connect with attendees</li>
                </ul>
              </div>
              ...
              <div className="text-center pt-4 border-t border-gray-200">
                ...
                <Button asChild variant="link" className="text-yellow-600 hover:text-yellow-700 p-0">
                  <a href="mailto:support@bestcarsales.com?subject=Event Submission Question" className="flex items-center justify-center">
